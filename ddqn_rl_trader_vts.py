...
def main():
    ...
    env_test = OcNewActionSpaceEnv(TIME_STEP, variety=variety, path=PATH_TRAIN)
    ...
    model = create_dense_model(shape=env.shape, nb_actions=nb_actions)
    print(model.summary())
